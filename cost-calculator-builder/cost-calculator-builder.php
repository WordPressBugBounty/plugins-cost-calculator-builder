...
define( 'CALC_VERSION', '3.2.44' );
define( 'CALC_WP_TESTED_UP', '6.7' );
define( 'CALC_DB_VERSION', '3.2.42' );
...
require_once CALC_PATH . '/includes/classes/pdf-manager/CCBPdfManagerHelper.php';
