...
= 4.0.14 =
- Fix: Page Pagination was not appearing when Mobile Mode was enabled
- Fix: Discounts were not displaying in Mobile Mode

= 4.0.13 =
- Update: Added option to enable or disable Mobile Summary on mobile devices

= 4.0.12 =
- Fix: Minor bugfixes.

= 4.0.11 =
- Fix: Basic Slider element is too small to grab on mobile devices
- Fix: Total Summary on mobile was summing all totals by default, even when not selected

= 4.0.10 =
- Fix: Upload image button is not working for Image Radio, Image Checkbox, Image Dropdown elements
- Fix: Payment fields are not clickable after choosing option in Required element
...
- Fix: Border settings in Themes were not applying to some form elements, including Time Picker, File Upload, Page Navigation, Submit Order, PDF Download, Share Quote, and Geolocation fields.
...
= 3.6.14 =
- Enhancement: Added the ability to add hints for options in Radio field.
- Fix: Fixed values above 1000 being treated as decimals in Quantity field when Set Measurement Unit or Currency Settings is enabled and Number of Decimals is set to 0.
...
= 3.5.32 =
- Enhancement: Added an option to show or hide the Calculator Title.

= 3.5.31 =
- Fix: Fixed an issue where Unit Measurement and Currency Sign symbols were not applied to the Quantity Field, Basic Slider, and Multi Range elements.

= 3.5.30 =
- Improvement: Strings in the Analytics dashboard are now available for translation in Loco Translate. (Pro)

= 3.5.29 =
- Improvement: Added an action in Conditions to unset options for checkbox and image checkbox fields, allowing more granular control instead of clearing all options at once.
...
- Fix: Fixed bugs in Quantity element's "Currency Settings"
- Fix: Fixed currency sign showing for Quantity element even when the “Currency Sign” setting was disabled
...
= 3.5.14 =
- Fix: Fixed an issue where Summary Details would not appear when more than two calculators were embedded on the same page.

= 3.5.13 =
- Enhancement: Added a new Description setting for the Formula element that can be useful for providing additional information such as calculation notes or details for order summaries.
- Fix: Fixed an issue where the “Total” label in the Summary section was not being translated.

= 3.5.12 =
- Fix: Fixed issue with Additional Classes not applying to Formula elements
...
= 3.5.8 =
- Fix: Fixed desktop Appearance settings being applied instead of mobile settings when viewed on mobile.
- Fix: Resolved display issues with elements in the Horizontal layout.

= 3.5.7 =
- Fix: Fixed minor bugs.

= 3.5.6 =
- Fix: Fixed various visual bugs affecting different calculator layouts in mobile view.
...
= 3.5.2 =
- New: Added "Help Center" page for quick access to the plugin’s documentation and support resources.

= 3.5.1 =
- Fix: Resolved mismatch between totals shown in the summary and totals in the order.
...
= 3.2.69 =
- Enhancement: Added a switch toggle to the Formula element for more advanced calculations.

= 3.2.68 =
- Fix: Minor bug fixes.

= 3.2.67 =
- Fix: Fixed an issue when the selected box style was not applied to Radio Select in the calculator.
