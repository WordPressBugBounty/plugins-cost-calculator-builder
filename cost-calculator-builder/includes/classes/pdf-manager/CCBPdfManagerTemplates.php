...
class CCBPdfManagerTemplates {
				...
				'company_block'         => array(
					...
					'tabs'    => array(
						...
						'contacts' => array(
							...
							'key'   => 'contacts',
							'data'  => array(
								'phone'       => CCBPdfManagerHelper::get_pdf_contact_info_data( $company_block['contacts']['phone_status'], 'Phone', $company_block['contacts']['phone'], 'phone' ),
								'email'       => CCBPdfManagerHelper::get_pdf_contact_info_data( $company_block['contacts']['email_status'], 'Email', $company_block['contacts']['email'], 'email', 'john@doe.com' ),
								'messenger'   => CCBPdfManagerHelper::get_pdf_contact_info_data( $company_block['contacts']['messenger_status'], 'Messenger', $company_block['contacts']['messenger'], 'messenger', '@name' ),
								'site_url'    => CCBPdfManagerHelper::get_pdf_contact_info_data( $company_block['contacts']['site_url_status'], 'Site', $company_block['contacts']['site_url'], 'site_url', 'site.com' ),
	...
	public static function ccb_extract_template_data( $data, $key = 'default' ) {
		...
		if ( ! empty( $data['sections']['footer_text']['tabs'] ) ) {
			...
			$template['sections']['footer_text']['text']['title'] = $text['data']['description']['value'];
