...
function ccb_get_nonces() {
	return array(
		...
		'ccb_calc_views'          => wp_create_nonce( 'ccb_calc_views' ),
		'ccb_calc_interactions'   => wp_create_nonce( 'ccb_calc_interactions' ),
	);
}
...
function ccb_add_admin_nonces() {
	$variables = array(
		...
		'ccb_orders'                    => wp_create_nonce( 'ccb_orders' ),
		'ccb_orders_list'               => wp_create_nonce( 'ccb_orders_list' ),
		...
		'ccb_save_section_icon'         => wp_create_nonce( 'ccb_save_section_icon' ),
		'ccb_save_total_icon'           => wp_create_nonce( 'ccb_save_total_icon' ),
		'ccb_generate_formula'          => wp_create_nonce( 'ccb_generate_formula' ),
		'ccb_get_forms'                 => wp_create_nonce( 'ccb_get_forms' ),
		'ccb_get_active_form_fields'    => wp_create_nonce( 'ccb_get_active_form_fields' ),
		'ccb_create_default_form'       => wp_create_nonce( 'ccb_create_default_form' ),
		'ccb_delete_form'               => wp_create_nonce( 'ccb_delete_form' ),
		...
		'ccb_single_calc_analytics'     => wp_create_nonce( 'ccb_single_calc_analytics' ),
		'ccb_analytics_page_settings'   => wp_create_nonce( 'ccb_analytics_page_settings' ),
		'ccb_analytics_add_widget'      => wp_create_nonce( 'ccb_analytics_add_widget' ),
		'ccb_update_status_list'        => wp_create_nonce( 'ccb_update_status_list' ),
		'ccb_update_order_status'       => wp_create_nonce( 'ccb_update_order_status' ),
		'ccb_save_table_settings'       => wp_create_nonce( 'ccb_save_table_settings' ),
		'ccb_save_orders_settings'      => wp_create_nonce( 'ccb_save_orders_settings' ),
		'ccb_restore_orders_settings'   => wp_create_nonce( 'ccb_restore_orders_settings' ),
		'ccb_restore_table_settings'    => wp_create_nonce( 'ccb_restore_table_settings' ),
		'ccb_delete_status'             => wp_create_nonce( 'ccb_delete_status' ),
		'ccb_delete_order'              => wp_create_nonce( 'ccb_delete_order' ),
		'ccb_create_order_note'         => wp_create_nonce( 'ccb_create_order_note' ),
		'ccb_update_order_note'         => wp_create_nonce( 'ccb_update_order_note' ),
		'ccb_delete_order_note'         => wp_create_nonce( 'ccb_delete_order_note' ),
