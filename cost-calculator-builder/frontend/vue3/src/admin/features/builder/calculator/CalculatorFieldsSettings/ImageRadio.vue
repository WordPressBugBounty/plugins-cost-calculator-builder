  ...
  <div class="ccb-fields-settings-container ccb-custom-scrollbar">
    <div class="ccb-fields-settings ccb-field-sidebar">
      ...
      <div class="ccb-field-sidebar__header">
        <Text :text="field.label" size="m" weight="bold" />
      </div>
      ...
      <div class="ccb-field-sidebar__body" v-if="activeTab === 'variants'">
        ...
        <div class="ccb-field-sidebar__row">
          <Toggle
            label="Apply to All Image Radio Fields in Calculator"
            size="m"
            weight="medium"
        ...
        <div class="ccb-field-sidebar__body">
          ...
          <div class="ccb-field-sidebar__item">
            <Notice type="success">
              ...
              <a href="https://iconscout.com/" target="_blank">iconscout.com</a>
              or other services.
...
import defaultImage from "@/images/fields-variants/radio-img/default.png";
import withIconImage from "@/images/fields-variants/radio-img/box.png";
...
const draft = reactive<IImageRadioDraft>({
  label: "",
  fieldName: "",
  description: "",
  width: 100,
...
const normalizeOptions = (options: unknown): IImageRadioOption[] => {
