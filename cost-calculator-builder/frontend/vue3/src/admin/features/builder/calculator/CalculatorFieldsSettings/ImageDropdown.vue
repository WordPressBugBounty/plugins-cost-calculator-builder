...
interface IDropdownWithImageDraft {
  label: string;
  fieldName: string;
  description: string;
  width: number;
...
const draft = reactive<IDropdownWithImageDraft>({
  label: "",
  fieldName: "",
  description: "",
  width: 100,
...
const normalizeOptions = (options: unknown): IImageOption[] => {
