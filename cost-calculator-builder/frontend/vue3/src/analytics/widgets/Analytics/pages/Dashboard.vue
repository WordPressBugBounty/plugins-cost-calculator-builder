...
import { Skeleton } from "@/analytics/shared/ui/components/Skeleton";
  ...
  return (chartType: string) => {
    if (chartType === "bar") {
      return defineAsyncComponent(
        () => import("@/analytics/shared/ui/components/charts/BarChart.vue"),
      );
    } else if (chartType === "columns") {
      return defineAsyncComponent(
        () =>
          import("@/analytics/shared/ui/components/charts/ColumnsChart.vue"),
      );
    } else if (chartType === "line") {
      return defineAsyncComponent(
        () => import("@/analytics/shared/ui/components/charts/LinearChart.vue"),
      );
    } else if (chartType === "pie") {
      return defineAsyncComponent(
        () => import("@/analytics/shared/ui/components/charts/PieChart.vue"),
      );
    }
  };
});
