...
$end_date     = new DateTime( '2026-06-28 23:59:00' );
$current_time = new DateTime();


$is_promotion = $current_time >= $start_date && $current_time < $end_date;
...
if ( $is_promotion ) {
	...
	$freemius_info['plan']['licenses_5000']->lifetime_price = 749;
	$freemius_info['plan']['licenses_5']->lifetime_price    = 299;
	$freemius_info['plan']['licenses_1']->lifetime_price    = 149;
}
		...
		<div class="container">
			...
			<?php if ( $is_promotion ) : ?>
				<div class="stm-discount">
					<a href="https://stylemixthemes.com/cost-calculator-plugin/pricing/?utm_source=wpadmin&utm_medium=push&utm_campaign=costcalculator&utm_content=gopro&utm_term=summersale26&plugin_coupon=MIDSUMMER26" target="_blank"></a>
				</div>
			<?php endif; ?>
						...
						<?php if ( ! $plan->is_hidden ) : ?>
							<div class="col-md-4">
								<div class="stm_plan <?php echo esc_attr( $plan->data['classname'] ); ?>">
									...
									if ( $is_promotion ) {
										$get_now_link .= '&plugin_coupon=MIDSUMMER26';
									}
									?>
