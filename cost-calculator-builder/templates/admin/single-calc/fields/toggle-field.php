<div class="cbb-edit-field-container">
	<div class="ccb-edit-field-header">
		<span class="ccb-edit-field-title ccb-heading-3 ccb-bold"><?php esc_html_e( 'Switch toggle', 'cost-calculator-builder' ); ?></span>
		<div class="ccb-field-actions">
			...
			<button class="ccb-button success" @click.prevent="save(toggleField, id, index, toggleField.alias)"><?php esc_html_e( 'Save', 'cost-calculator-builder' ); ?></button>
		</div>
	</div>
	<div class="ccb-grid-box">
						...
						>
							<div class="ccb-option" v-for="(option, index) in fieldOptions" :key="index">
								...
								<div class="ccb-option-inner">
									<div class="ccb-input-wrapper">
										<input type="text" class="ccb-heading-5 ccb-light" min="0" step="1" :name="'option_' + index" @keyup="checkRequired('errorOptionValue' + index)" v-model="option.optionValue" placeholder="<?php esc_attr_e( 'Value', 'cost-calculator-builder' ); ?>">
		...
		<div class="container" v-show="tab === 'style' && typeof toggleField.styles !== 'undefined'">
			<?php if ( defined( 'CCB_PRO' ) ) : ?>
				<div class="row ccb-p-t-15" style="align-items: flex-end !important;" v-if="toggleField.styles">
					<div class="col-6">
						<div class="ccb-select-box">
							<span class="ccb-select-label"><?php esc_html_e( 'Style', 'cost-calculator-builder' ); ?></span>
							<div class="ccb-select-wrapper">
								<i class="ccb-icon-Path-3485 ccb-select-arrow"></i>
								<select class="ccb-select" v-model="toggleField.styles.style" style="padding-right: 30px !important;">
									<option v-for="opt in getToggleStyles" :key="opt.value" :value="opt.value">{{ opt.label }}</option>
								</select>
							</div>
						</div>
					</div>
					<div class="col-6" v-if="toggleField.styles.style !== 'box-with-toggle-and-description'">
						<div class="ccb-select-box" :class="{'disabled': toggleField.styles.style === 'boxed-with-description'}">
							<span class="ccb-select-label"><?php esc_html_e( 'Box style', 'cost-calculator-builder' ); ?></span>
							<div class="ccb-select-wrapper">
								<i class="ccb-icon-Path-3485 ccb-select-arrow"></i>
								<select class="ccb-select" v-model="toggleField.styles.box_style" style="padding-right: 30px !important;">
				...
				<div class="row ccb-p-t-15">
					<div class="col-12">
						<div class="list-header">
							...
							<h6 class="ccb-heading-5" style="font-size: 14px"><?php esc_html_e( 'Apply this toggle style to all toggle fields in this calculator', 'cost-calculator-builder' ); ?></h6>
						</div>
					</div>
				</div>
			<?php else : ?>
		...
		<div class="container" v-show="tab === 'options'">
			<div class="row ccb-p-t-15">
				...
				<div class="col-6 ccb-p-t-10" v-if="!disableFieldHiddenByDefault(toggleField)">
					<div class="list-header">
						<div class="ccb-switch">
